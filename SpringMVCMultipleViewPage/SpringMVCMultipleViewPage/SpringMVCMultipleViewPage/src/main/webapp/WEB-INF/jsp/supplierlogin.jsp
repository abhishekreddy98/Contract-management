...
font-weight: bold;
	...
	<div class="container">
		...
		<form action="suppdata" method="post">
			...
			<center><input type="text" name="id" placeholder="Enter your userid" required></center><br>
			<center><p><font size="4">Password</p></font></center>
			<center><input type="password" id="password" name="password" placeholder="Enter your password" required></center><br>
